...
CREATE TABLE IF NOT EXISTS license_info (
    ...
    status ENUM('active', 'grace', 'expired', 'invalid', 'suspended') DEFAULT 'active',
    ...
    grace_expires_at DATETIME NULL COMMENT 'Server-side grace period expiry date',
...
CREATE TABLE IF NOT EXISTS license_validation_history (
    ...
    status ENUM('success', 'grace', 'expired', 'invalid', 'suspended', 'error') NOT NULL,
