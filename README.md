...
| [PatchCreator](PatchCreator/)       | v1.02.00 | Bash patch package builder for PatchModule with git diff and SHA-256 verification     |
| [PatchModule](PatchModule/)         | v1.6.3   | Framework-agnostic patch management with update checking, installation, and rollback  |
