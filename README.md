...
| [PatchCreator](PatchCreator/)       | v1.04.00 | Bash patch package builder for PatchModule with git diff and SHA-256 verification     |
| [PatchModule](PatchModule/)         | v2.2.0   | Framework-agnostic patch management with update checking, installation, and rollback  |
